...
/* ── Neutral dark-grey palette (matching oklch theme, NOT blue-tinted) ── */
const BG        = '#1c1c1e'   // oklch(0.18 0.005 270) ≈ neutral dark grey
const CARD      = '#262628'   // oklch(0.22 0.005 270)
const INPUT_BG  = '#1a1a1c'   // slightly darker than card
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Silver fern — large background element */}
        <div
          style={{
            position: 'absolute',
            left: '-40px',
        ...
        >
          ...
          >
            <span style={{ fontSize: '11px', fontWeight: 500, color: TXT_DIM }}>
              From:
            </span>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              >
                ...
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" style={{ marginLeft: '2px' }}>
                  <path d="M6 9l6 6 6-6" stroke={TXT_DIM} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </div>
              {/* Amount + USD */}
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '2px' }}>
                ...
                <span style={{ fontSize: '11px', color: TXT_DIM }}>
                  ~$2,241.80
                </span>
              </div>
            </div>
          ...
          {/* ── To input (with swap button overlapping top) ── */}
          <div
            style={{
              display: 'flex',
              flexDirection: 'column',
          ...
          >
            {/* Swap direction button — overlaps top edge */}
            <div
              style={{
                position: 'absolute',
                top: '-18px',
          ...
          <div style={{ display: 'flex', marginTop: '14px', padding: '0 2px' }}>
            <div
              style={{
                ...
                justifyContent: 'center',
                boxShadow:
                  '0 0 28px rgba(16,185,129,0.20), 0 4px 8px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.08)',
                position: 'relative',
              }}
            >
              <div
              ...
              />
              <span style={{ fontSize: '14px', fontWeight: 700, color: '#ffffff', position: 'relative' }}>
                Swap
              </span>
            </div>
          </div>
